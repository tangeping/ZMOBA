/*
	...
	Please inherit this module, such as: (class MatchAvatar : MatchAvatarBase)
	tools = kbcmd
*/
...
namespace KBEngine
{
	...
	public abstract class MatchAvatarBase : EntityComponent
	{
		public EntityBaseEntityCall_MatchAvatarBase baseEntityCall = null;
		public EntityCellEntityCall_MatchAvatarBase cellEntityCall = null;
		...
		{
			return EntityDef.moduledefs["MatchAvatar"];
		}

		public override void onRemoteMethodCall(UInt16 methodUtype, MemoryStream stream)
		{
			ScriptModule sm = EntityDef.moduledefs["MatchAvatar"];
